...
class TestSmokeTest():
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1166, 692)
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("faharetana")
  ...
  def test_joinpage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Faharetana")
    self.driver.find_element(By.NAME, "lname").send_keys("Rakotomaonjy")
    self.driver.find_element(By.NAME, "bizname").send_keys("Trans Colis")
